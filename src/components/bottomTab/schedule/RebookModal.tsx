...
const DATE_OPTIONS = [
  ...
  { label: 'Sat', date: '05/07/2026', day: '05 Jul' },
];
...
export default function RebookModal({
  ...
  const handleConfirm = () => {
    onConfirmRebook(appointment, selectedDate, selectedTime, selectedType);
    onClose();
  };
        ...
        <View style={styles.sheetContainer}>
          ...
          <View style={styles.headerRow}>
            <View style={styles.titleWithIcon}>
              ...
              <Text style={styles.sheetTitle}>Re-Book Appointment</Text>
            </View>
          ...
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
            ...
            <View style={styles.doctorCard}>
              ...
              <View style={styles.doctorInfo}>
                ...
                <View style={styles.ratingRow}>
                  ...
                  <Text style={styles.feeBadge}>$50.00 / session</Text>
                </View>
              </View>
            </View>
            ...
            <View style={styles.summaryBox}>
              <View style={styles.summaryRow}>
                <Text style={styles.summaryLabel}>Re-Booking Schedule:</Text>
            ...
            >
              ...
              <Text style={styles.confirmButtonText}>Confirm & Re-Book</Text>
            </TouchableOpacity>
          </ScrollView>
        </View>
      </View>
